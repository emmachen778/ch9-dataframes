...
got.largest.grant <- grants$organization[grants$total_amount == largest.grant]

# Which organization received the smallest grant?
got.smallest.grant <- grants$organization[grants$total_amount == smallest.grant]

# How many grants were awarded in 2010?
in.2010 <- length(grants$start_year[grants$start_year == 2010])
